...
export const GrabPayActions = {
  ...
  OneTimeCharge: {
    TRIGGER_INIT: "OTC.TRIGGER_INIT",
    TRIGGER_CONFIRM: "OTC.TRIGGER_CONFIRM"
  },

  RecurringCharge: {
    TRIGGER_BIND: "RC.TRIGGER_BIND",
    TRIGGER_CHARGE: "RC.TRIGGER_CHARGE",
    TRIGGER_UNBIND: "RC.TRIGGER_UNBIND"
  },
  ...
  Transaction: {
    ...
    SET_PARTNER_TRANSACTION_ID: "TX.SET_PARTNER_TRANSACTION_ID",
    SET_TRANSACTION_STATUS: "TX.SET_TRANSACTION_STATUS"
  }
};
